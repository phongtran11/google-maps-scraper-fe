...
*   **Nội dung thay đổi**:
    ...
    2.  **Hàm Làm Sạch Địa Chỉ (`cleanAddress`)**: Tích hợp lọc bỏ các tên đường dễ gây nhiễu và trùng tên với địa danh vùng (như *"Đường Bình Giã"*, *"Đường Đất Đỏ"*, *"ấp Phước Trung"*,...).
